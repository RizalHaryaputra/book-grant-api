...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('manuscript_files')->truncate();
        ...
        DB::table('manuscripts')->insert([
            ...
            [
                ...
                'book_type' => 'Buku Ajar',
                'abstract' => 'Buku ini membahas dasar-dasar analisis algoritma dan struktur data...',
                'science_field' => 'Bidang Ilmu A',
                'total_pages' => 220,
        ...
        // 5b. SEED TABLE: MANUSCRIPT_FILES (File Draft Awal)
        DB::table('manuscript_files')->insert([
            [
                'id' => 1,
                'manuscript_id' => 1,
                'file_path' => 'uploads/manuscripts/laravel_web_modern.pdf',
                'file_type' => 'initial',
                'version' => 1,
                'revision_note' => null,
                'uploaded_at' => now(),
            ...
            [
                'id' => 2,
                'manuscript_id' => 2,
                'file_path' => 'uploads/manuscripts/analisis_algoritma.pdf',
                'file_type' => 'initial',
                'version' => 1,
                'revision_note' => null,
                'uploaded_at' => now(),
